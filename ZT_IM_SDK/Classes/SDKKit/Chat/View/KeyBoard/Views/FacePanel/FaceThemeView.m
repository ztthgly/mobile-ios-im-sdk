...
- (void)initSubViews
{
    ...
    _pageControl.pageIndicatorTintColor = [UIColor colorWithRed:222/255.f green:222/255.f blue:222/255.f alpha:1.0];
    _pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:140/255.f green:140/255.f blue:140/255.f alpha:1.0];
